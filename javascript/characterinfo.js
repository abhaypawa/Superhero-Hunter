window.onload = function () {
    ...
    // chracter details
    let url = `https://gateway.marvel.com:443/v1/public/characters?name=spider-man&limit=20&apikey=92afcbe2a13e5254d5235963c84ed0b5
    `;
    fetch(url)
      .then((response) => {
    ...
    url = `https://gateway.marvel.com:443/v1/public/characters?name=spider-man&limit=20&apikey=92afcbe2a13e5254d5235963c84ed0b5
    `;
