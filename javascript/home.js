...
fetchData()
  ...
  // if any error occured while fetching data from api then display
  .catch((error) => {
    console.error(error);
  });
...
searchBtn.addEventListener("click", () => {
  ...
  let url = `https://gateway.marvel.com:443/v1/public/characters?name=${query}%3D&apikey=92afcbe2a13e5254d5235963c84ed0b5
  `;
